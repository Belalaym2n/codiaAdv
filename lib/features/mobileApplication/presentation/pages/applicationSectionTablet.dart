...
class ApplicationPageTablet extends StatefulWidget {
    ApplicationPageTablet({ super.key,
    required this.width,
  ...
  @override
  State<ApplicationPageTablet> createState() =>
      _WebMobileApplicationSectionState();
}

class _WebMobileApplicationSectionState
    extends State<ApplicationPageTablet> {
  bool _showContent = false;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: Drawer(child: DrawerScreen(width: widget.width, height: widget.height)),

      body: SafeArea(
        child: Column(
          children: [
            TabletHeader(width: widget.width, height: widget.height,),
